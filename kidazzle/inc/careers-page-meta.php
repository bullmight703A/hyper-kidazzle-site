 ...
 */
function kidazzle_careers_page_meta_boxes() {
	add_meta_box(
		'kidazzle-careers-hero',
		__( 'Hero Section', 'kidazzle-theme' ),
		'kidazzle_careers_hero_meta_box_render',
		'page',
		'normal',
		'high'
	);
	...
	add_meta_box(
		'kidazzle-careers-culture',
		__( 'Culture & Benefits Section', 'kidazzle-theme' ),
		'kidazzle_careers_culture_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'kidazzle-careers-openings',
		__( 'Current Opportunities Section (3 Job Listings)', 'kidazzle-theme' ),
		'kidazzle_careers_openings_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'kidazzle-careers-cta',
		__( 'Application CTA Section', 'kidazzle-theme' ),
		'kidazzle_careers_cta_meta_box_render',
		'page',
		'normal',
		'default'
	);
}
add_action( 'add_meta_boxes', 'kidazzle_careers_page_meta_boxes' );

/**
 * Hero Section Meta Box
 */
function kidazzle_careers_hero_meta_box_render( $post ) {
	wp_nonce_field( 'kidazzle_careers_hero_meta', 'kidazzle_careers_hero_nonce' );
		...
		<tr>
			...
			<td>
				<input type="text" id="careers_hero_title" name="careers_hero_title"
					   ...
					   class="large-text" />
				<p class="description">Use &lt;br&gt; for line breaks and &lt;span class="italic text-kidazzle-red"&gt; for styled text</p>
			</td>
		</tr>
		<tr>
 ...
 */
function kidazzle_careers_culture_meta_box_render( $post ) {
	wp_nonce_field( 'kidazzle_careers_culture_meta', 'kidazzle_careers_culture_nonce' );
 ...
 */
function kidazzle_careers_openings_meta_box_render( $post ) {
	wp_nonce_field( 'kidazzle_careers_openings_meta', 'kidazzle_careers_openings_nonce' );
 ...
 */
function kidazzle_careers_cta_meta_box_render( $post ) {
	wp_nonce_field( 'kidazzle_careers_cta_meta', 'kidazzle_careers_cta_nonce' );
 ...
 */
function kidazzle_save_careers_page_meta( $post_id ) {
	...
	$meta_boxes = array(
		'kidazzle_careers_hero_nonce' => array(
		...
		'kidazzle_careers_culture_nonce' => array(
		...
		'kidazzle_careers_openings_nonce' => array(
		...
		'kidazzle_careers_cta_nonce' => array(
...
add_action( 'save_post', 'kidazzle_save_careers_page_meta' );

/**
 * Seed default values for Careers page when template is first applied
 */
function kidazzle_seed_careers_page_defaults( $post_id ) {
	// Check if this is a page
	if ( get_post_type( $post_id ) !== 'page' ) {
		return;
	}
...
add_action( 'save_post', 'kidazzle_seed_careers_page_defaults', 5 );
