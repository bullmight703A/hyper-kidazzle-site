 ...
 */
function kidazzle_contact_page_meta_boxes() {
	add_meta_box(
		'kidazzle-contact-hero',
		__( 'Hero Section', 'kidazzle-theme' ),
		'kidazzle_contact_hero_meta_box_render',
		'page',
		'normal',
		'high'
	);
	...
	add_meta_box(
		'kidazzle-contact-form',
		__( 'Form Settings', 'kidazzle-theme' ),
		'kidazzle_contact_form_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'kidazzle-contact-corporate',
		__( 'Corporate Office Info', 'kidazzle-theme' ),
		'kidazzle_contact_corporate_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'kidazzle-contact-careers',
		__( 'Careers Section', 'kidazzle-theme' ),
		'kidazzle_contact_careers_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'kidazzle-contact-press',
		__( 'Press Inquiries Section', 'kidazzle-theme' ),
		'kidazzle_contact_press_meta_box_render',
		'page',
		'normal',
		'default'
	);
}
add_action( 'add_meta_boxes', 'kidazzle_contact_page_meta_boxes' );

/**
 * Hero Section Meta Box
 */
function kidazzle_contact_hero_meta_box_render( $post ) {
	wp_nonce_field( 'kidazzle_contact_hero_meta', 'kidazzle_contact_hero_nonce' );
 ...
 */
function kidazzle_contact_form_meta_box_render( $post ) {
	wp_nonce_field( 'kidazzle_contact_form_meta', 'kidazzle_contact_form_nonce' );
 ...
 */
function kidazzle_contact_corporate_meta_box_render( $post ) {
	wp_nonce_field( 'kidazzle_contact_corporate_meta', 'kidazzle_contact_corporate_nonce' );
 ...
 */
function kidazzle_contact_careers_meta_box_render( $post ) {
	wp_nonce_field( 'kidazzle_contact_careers_meta', 'kidazzle_contact_careers_nonce' );
 ...
 */
function kidazzle_contact_press_meta_box_render( $post ) {
	wp_nonce_field( 'kidazzle_contact_press_meta', 'kidazzle_contact_press_nonce' );
 ...
 */
function kidazzle_save_contact_page_meta( $post_id ) {
	...
	$meta_boxes = array(
		'kidazzle_contact_hero_nonce' => array(
		...
		'kidazzle_contact_form_nonce' => array(
			'contact_form_submit_text' => 'sanitize_text_field',
		),
		'kidazzle_contact_corporate_nonce' => array(
		...
		'kidazzle_contact_careers_nonce' => array(
		...
		'kidazzle_contact_press_nonce' => array(
...
add_action( 'save_post', 'kidazzle_save_contact_page_meta' );

/**
 * Seed default values for Contact page
 */
function kidazzle_seed_contact_page_defaults( $post_id ) {
	if ( get_post_type( $post_id ) !== 'page' ) {
		return;
	}
...
add_action( 'save_post', 'kidazzle_seed_contact_page_defaults', 5 );
