...
function kidazzle_parents_page_meta_boxes() {
	...
	add_meta_box(
		...
		__( 'Parent Essentials (6 Resource Cards)', 'kidazzle-theme' ),
	...
	add_meta_box(
		...
		__( 'Nutrition & Menus Section', 'kidazzle-theme' ),
	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				...
				<button type="button" class="button kidazzle-upload-button" data-field="parents_events_image">Select Image</button>
				<button type="button" class="button kidazzle-clear-button" data-field="parents_events_image">Clear</button>
			</td>
		</tr>
	</table>
		...
		<tr>
			...
			<td>
				<input type="text" id="parents_nutrition_image" name="parents_nutrition_image"
					   ...
					   class="large-text kidazzle-image-field" />
				<button type="button" class="button kidazzle-upload-button" data-field="parents_nutrition_image">Select Image</button>
				<button type="button" class="button kidazzle-clear-button" data-field="parents_nutrition_image">Clear</button>
			</td>
		</tr>
	</table>
