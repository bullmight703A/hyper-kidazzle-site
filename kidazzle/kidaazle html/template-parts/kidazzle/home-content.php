    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-xl bg-white/40 backdrop-blur-md p-6 md:p-10 rounded-[3rem] shadow-2xl border border-white/50">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <a href="/about/"
                    class="bg-white/80 text-slate-900 border-2 border-slate-900 hover:border-indigo-600 hover:text-indigo-700 font-bold py-4 px-10 rounded-2xl transition flex items-center justify-center text-center">Our
                    Legacy</a>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-8 mt-4">
                <div>
                    <span class="text-orange-600 font-bold tracking-widest uppercase text-sm mb-2 block">Our
                        Roots</span>
                    <h2 class="text-4xl font-extrabold text-slate-900 mb-6 leading-tight">From a Women's Shelter to a
                    ...
                    <div class="mt-8">
                        <a href="/about/"
                            class="inline-flex items-center gap-2 text-indigo-600 font-bold hover:underline transition">Read
                            the full legacy <i data-lucide="arrow-right" class="w-5 h-5"></i></a>
                    </div>
                </div>
...
<section class="w-full bg-slate-100 border-t border-slate-200">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d850239.3877969824!2d-85.18731326464843!3d33.68415715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88f5038148b5cc13%3A0xc6cb70ebefbab2f2!2sKIDazzle%20Child%20Care%20Inc.!5e0!3m2!1sen!2sus!4v1709425812952!5m2!1sen!2sus" 
        width="100%" 
        height="450" 
        style="border:0;" 
        allowfullscreen="" 
