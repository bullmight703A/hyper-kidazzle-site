...
<body <?php body_class('font-sans text-brand-ink bg-white'); ?>>
	...
	<a href="#main-content"
		class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:bg-white focus:text-indigo-600 focus:p-4 focus:z-[100] focus:rounded-lg focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"><?php _e('Skip to main content', 'kidazzle-theme'); ?></a>
	...
	<nav class="sticky top-0 w-full z-40 bg-white py-4 shadow-sm border-b border-slate-100">
		<div class="container mx-auto px-4 flex justify-between items-center">
			...
			<button id="mobile-menu-btn" aria-label="Toggle mobile menu" class="lg:hidden text-slate-900"><i data-lucide="menu"
