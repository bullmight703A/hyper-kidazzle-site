...
<main id="main-content" class="bg-brand-cream min-h-screen">
	<article class="relative">
		...
		<header class="py-20 text-center max-w-4xl mx-auto px-4 relative z-10">
			<div
				class="inline-flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.2em] text-kidazzle-blue mb-8 bg-white px-5 py-2 rounded-full shadow-sm border border-brand-ink/5">
				<span class="w-2 h-2 bg-kidazzle-blue rounded-full pulse-slow"></span>
			...
			<div class="flex items-center justify-center gap-4">
				<div class="relative">
					...
					<div
						class="absolute -bottom-1 -right-1 w-6 h-6 bg-kidazzle-yellow rounded-full flex items-center justify-center border-2 border-white">
				...
				<div class="flex items-center gap-4">
					...
					<div class="flex gap-3">
						<a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank"
							class="w-10 h-10 rounded-full bg-white border border-brand-ink/10 flex items-center justify-center text-brand-ink hover:bg-kidazzle-blue hover:text-white transition-all shadow-sm">
							<i class="fa-brands fa-facebook-f"></i>
						</a>
						<a href="https://twitter.com/intent/tweet?url=<?php the_permalink(); ?>&text=<?php the_title(); ?>"
							target="_blank"
							class="w-10 h-10 rounded-full bg-white border border-brand-ink/10 flex items-center justify-center text-brand-ink hover:bg-black hover:text-white transition-all shadow-sm">
							<i class="fa-brands fa-x-twitter"></i>
						</a>
						<a href="mailto:?subject=<?php the_title(); ?>&body=<?php the_permalink(); ?>"
							class="w-10 h-10 rounded-full bg-white border border-brand-ink/10 flex items-center justify-center text-brand-ink hover:bg-kidazzle-red hover:text-white transition-all shadow-sm">
		...
		<section class="bg-white py-24 border-t border-brand-ink/5">
			<div class="max-w-7xl mx-auto px-4 lg:px-6">
				<div class="flex justify-between items-end mb-12">
					<div>
						<span class="text-kidazzle-blue font-bold tracking-[0.2em] text-[10px] uppercase mb-2 block">Read
							More</span>
					...
					<a href="<?php echo esc_url(home_url('/stories/')); ?>"
						class="hidden md:inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-kidazzle-blue hover:gap-4 transition-all pb-1 border-b-2 border-kidazzle-blue/20">
