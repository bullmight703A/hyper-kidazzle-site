...
<body class="bg-brand-cream text-brand-ink antialiased flex flex-col min-h-screen">
  ...
  <main class="flex-grow flex flex-col items-center justify-center text-center px-4">
    <div class="text-9xl font-serif font-bold text-kidazzle-yellow opacity-50 mb-4">404</div>
    ...
    <div class="flex flex-wrap justify-center gap-4">
      <a href="<?php echo esc_url(home_url('/')); ?>"
        class="px-8 py-3 bg-brand-ink text-white font-bold rounded-full uppercase tracking-widest text-xs hover:bg-kidazzle-blue transition-colors">Go
        Home</a>
      <?php
      ...
      <a href="<?php echo esc_url($locations_url); ?>"
        class="px-8 py-3 bg-white border border-brand-ink/10 text-brand-ink font-bold rounded-full uppercase tracking-widest text-xs hover:border-kidazzle-blue hover:text-kidazzle-blue transition-colors">Find
        a School</a>
    </div>
  </main>
