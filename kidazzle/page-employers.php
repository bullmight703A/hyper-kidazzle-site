...
<main id="primary" class="site-main" role="main">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<section class="py-24 bg-brand-cream text-center">
			<div class="max-w-4xl mx-auto px-4">
				...
				<h1 class="font-serif text-5xl md:text-6xl text-brand-ink mb-6">
					Corporate Childcare Solutions: <span class="italic text-kidazzle-blue">Critical Infrastructure for
						Your Team</span>
				</h1>
				...
				<div class="grid md:grid-cols-2 gap-8">
					...
					<div
						...
						<div class="relative z-10">
							...
							<p class="text-sm font-bold text-kidazzle-blue mb-4 uppercase tracking-wider">
							...
							<a href="<?php echo esc_url($federal_link_url); ?>" target="_blank"
								class="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-brand-ink border-b border-kidazzle-blue pb-1 hover:text-kidazzle-blue transition-colors">
					...
					<div
						class="bg-white p-10 rounded-[2.5rem] shadow-soft border border-brand-ink/5 relative overflow-hidden group">
						<div class="absolute top-0 right-0 w-32 h-32 bg-kidazzle-green/5 rounded-full -mr-10 -mt-10">
						</div>
						<div class="relative z-10">
							<div
								class="w-12 h-12 bg-kidazzle-green text-white rounded-xl flex items-center justify-center text-xl mb-6 shadow-md">
								<i class="<?php echo esc_attr($georgia_icon); ?>"></i>
							</div>
							<h3 class="font-serif text-2xl font-bold text-brand-ink mb-3">
								<?php echo esc_html($georgia_title); ?>
							</h3>
							<p class="text-sm font-bold text-kidazzle-green mb-4 uppercase tracking-wider">
							...
							<a href="<?php echo esc_url($georgia_link_url); ?>" target="_blank"
								class="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-brand-ink border-b border-kidazzle-green pb-1 hover:text-kidazzle-green transition-colors">
		...
		<section id="contact" class="py-24 bg-kidazzle-blueDark text-white">
			<div class="max-w-4xl mx-auto px-4 lg:px-6 text-center">
				...
				<form class="max-w-md mx-auto space-y-4 text-brand-ink">
					...
					<input type="email" name="work_email" placeholder="Work Email" aria-label="Work Email"
						class="w-full p-4 rounded-xl" required>
					<button type="submit"
						class="w-full py-4 bg-kidazzle-yellow text-brand-ink font-bold rounded-full uppercase tracking-widest hover:bg-white transition-colors">
						Request Info Kit
					</button>
				</form>
			</div>
