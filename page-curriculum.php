...
<div class="grid md:grid-cols-2 gap-6 items-stretch mt-6">
	<div class="bg-white rounded-[3rem] p-10 md:p-16 border border-slate-200 flex flex-col justify-center">
		...
		<div class="space-y-6 text-lg text-slate-600 leading-relaxed font-medium">
			<p><?php _e('For our youngest learners, we utilize the nationally recognized <strong>Creative Curriculum®</strong>. This research-based framework focuses on the vital connection between caregiver and child, turning everyday moments into learning opportunities.', 'kidazzle'); ?>
			</p>
			<p><?php _e('We balance teacher-directed instruction with child-initiated exploration to support <strong>Social-Emotional, Physical, Language, and Cognitive</strong> domains.', 'kidazzle'); ?>
			</p>
		</div>
	</div>
...
<div class="grid md:grid-cols-3 gap-6">
	...
	<a href="<?php echo esc_url(home_url('/programs/ga-pre-k/')); ?>"
		...
		<p class="text-slate-600 leading-relaxed mb-6 flex-grow">
			<?php _e('Our Lottery Funded Pre-K program utilizes <strong>Frog Street</strong>, aligned with GELDS standards for joyful, rigorous kindergarten readiness.', 'kidazzle'); ?>
		</p>
	...
	<a href="<?php echo esc_url(home_url('/programs/tennessee/')); ?>"
		...
		<p class="text-slate-600 leading-relaxed mb-6 flex-grow">
			<?php _e('In Memphis, our curriculum adheres to the <strong>TN-ELDS</strong>, ensuring educational goals are met from birth to age 5.', 'kidazzle'); ?>
		</p>
	...
	<a href="<?php echo esc_url(home_url('/programs/vpk/')); ?>"
		...
		<p class="text-slate-600 leading-relaxed mb-6 flex-grow">
			<?php _e('Incorporating <strong>OWL</strong> and <strong>ASQ</strong> to meet Florida\'s VPK standards with a focus on literacy and bilingual support.', 'kidazzle'); ?>
		</p>
...
<div class="bg-white rounded-[3rem] p-10 md:p-16 border border-slate-200 mt-8 text-center">
	...
	<div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
		<a href="<?php echo esc_url(home_url('/quality-standards/#iters')); ?>"
		...
		<a href="<?php echo esc_url(home_url('/quality-standards/#ecers')); ?>"
	...
	<div class="relative z-10 flex flex-col md:flex-row items-center gap-12">
		...
		<div class="md:w-2/3 text-center md:text-left">
			...
			<p class="text-indigo-100 text-lg leading-relaxed mb-8">
				<?php _e('KIDazzle innovates by integrating an <strong>AI Lesson Plan Bot</strong> into our teacher resources. This tool helps educators instantly tailor the Creative Curriculum® to the specific needs of their current classroom, generating creative, standards-aligned activities in seconds.', 'kidazzle'); ?>
			</p>
