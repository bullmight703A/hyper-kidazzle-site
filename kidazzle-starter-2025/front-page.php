        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <a href="<?php echo esc_url(home_url('/meals/')); ?>"
                ...
                <p class="text-sm text-slate-600 mb-4 leading-relaxed">Our commercial-grade kitchens serve fresh, hot
                    meals prepared daily by professional chefs. We accommodate all dietary needs to fuel your child's
                    growing mind.</p>
                <span
            ...
            <a href="<?php echo esc_url(home_url('/staff/')); ?>"
                ...
                <p class="text-sm text-slate-600 mb-4 leading-relaxed">We pride ourselves on low turnover and a team of
                    tenured educators who truly know your child. Our staff receives ongoing training to provide the
                    highest quality care.</p>
                <span
            ...
            <a href="<?php echo esc_url(home_url('/curriculum/')); ?>"
                ...
                <p class="text-sm text-slate-600 mb-4 leading-relaxed">We utilize the research-based Creative
                    Curriculum® tailored to each developmental stage. From sensory play to pre-literacy, every activity
                    has a learning purpose.</p>
                <span
            ...
            <a href="<?php echo esc_url(home_url('/safety/')); ?>"
                ...
                <p class="text-sm text-slate-600 mb-4 leading-relaxed">Your peace of mind is our priority with secure
                    keypad entry and monitored surveillance. We maintain rigorous safety protocols exceeding state
                    standards.</p>
                <span
