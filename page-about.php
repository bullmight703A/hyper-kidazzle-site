...
<div class="bg-white rounded-[3rem] p-10 md:p-20 shadow-sm border border-slate-200 text-center mt-6">
	...
	<p class="text-xl text-slate-600 leading-relaxed max-w-4xl mx-auto">
		<?php _e('We understand that choosing a learning academy is one of the most significant decisions a parent makes. Our philosophy is simple: <strong>Excellence is standard.</strong> We bridge the gap between elite private education and accessible community care.', 'kidazzle'); ?>
	</p>
</div>
...
<div class="grid md:grid-cols-2 gap-6 items-stretch mt-6">
	<div class="bg-white rounded-[3rem] p-10 md:p-16 border border-slate-200 flex flex-col justify-center">
		...
		<div class="space-y-6 text-lg text-slate-600 leading-relaxed font-medium">
			<p><?php _e('KIDazzle was born from a mission of profound necessity. Thirty-one years ago, we opened our doors inside a <strong>women\'s shelter</strong>, dedicated to providing stability to families in transition.', 'kidazzle'); ?>
			</p>
			<p><?php _e('As we grew, we made a strategic choice to expand into <strong>urban centers</strong>—Memphis, Atlanta, Doral—where the need for high-quality, professional early childhood education was greatest.', 'kidazzle'); ?>
			</p>
		</div>
	</div>
