...
## Codebase Intelligence for hyper-kidazzle-site (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-20 (commit 61af7e83)
...
- `functions.php` — 6 bug fixes, last fix 4 months ago; 25 commits/90d
- `page-teacher-portal.php` — 1 bug fix, last fix 3 weeks ago; 10 commits/90d
- `page-digital-resources.php` — 3 commits/90d
- `inc/seo-automations/class-dynamic-titles.php` — 3 commits/90d

### Code health
Three co-equal signals: defect risk 9.7/10 avg, hotspot health 8.56/10 (stable), worst `functions.php` at 6.5/10 · maintainability 9.9/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `page-teacher-portal.php` — churn risk — impact −2.4
- `functions.php` — change entropy — impact −2.0
- `functions.php` — prior defect — impact −1.3
