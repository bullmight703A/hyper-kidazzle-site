...
<section class="py-16 bg-slate-50">
    <div class="max-w-7xl mx-auto px-6 space-y-24">
        ...
        <!-- Infants -->
        <div id="infants" class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <ul class="space-y-2 text-slate-700 mb-6">
                    <li class="flex items-start gap-2"><i data-lucide="check" class="text-cyan-500 w-5 h-5 mt-1"></i>
                        <span>Individualized feeding & nap schedules</span></li>
                    <li class="flex items-start gap-2"><i data-lucide="check" class="text-cyan-500 w-5 h-5 mt-1"></i> <span>Daily
                        digital reports & photos</span></li>
                </ul>
                <a href="<?php echo site_url('/contact'); ?>"
                    class="text-indigo-600 font-bold hover:underline flex items-center gap-2">
                    Inquire about Infant Care <i data-lucide="arrow-right" class="w-4 h-4"></i>
                </a>
            </div>
        </div>

        <!-- Toddlers -->
        <div id="toddlers" class="grid md:grid-cols-2 gap-12 items-center">
            <div class="order-2 md:order-1">
                ...
                <ul class="space-y-2 text-slate-700 mb-6">
                    <li class="flex items-start gap-2"><i data-lucide="check" class="text-red-500 w-5 h-5 mt-1"></i> <span>Potty
                        training support included</span></li>
                    <li class="flex items-start gap-2"><i data-lucide="check" class="text-red-500 w-5 h-5 mt-1"></i> <span>Safe outdoor
                        play & discovery zones</span></li>
                </ul>
                <a href="<?php echo site_url('/contact'); ?>"
                    class="text-indigo-600 font-bold hover:underline flex items-center gap-2">
        ...
        <!-- Preschool -->
        <div id="preschool" class="grid md:grid-cols-2 gap-12 items-center">
            <div class="rounded-3xl overflow-hidden shadow-xl">
            ...
            <div>
                ...
                <ul class="space-y-2 text-slate-700 mb-6">
                    <li class="flex items-start gap-2"><i data-lucide="check" class="text-yellow-500 w-5 h-5 mt-1"></i> <span>STEM
                        activities & simple coding</span></li>
                    <li class="flex items-start gap-2"><i data-lucide="check" class="text-yellow-500 w-5 h-5 mt-1"></i>
                        <span>Collaborative group projects</span></li>
                </ul>
                <a href="<?php echo site_url('/contact'); ?>"
                    class="text-indigo-600 font-bold hover:underline flex items-center gap-2">
...
<section class="py-20 bg-white text-center">
    <div class="max-w-3xl mx-auto px-6">
        ...
        <a href="<?php echo site_url('/contact'); ?>"
            class="bg-slate-900 text-white px-8 py-3 rounded-xl font-bold hover:bg-slate-700 transition shadow-lg">
