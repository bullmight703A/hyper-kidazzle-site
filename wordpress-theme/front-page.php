...
<header class="relative w-full h-[700px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        ...
        <!-- User Requested Overlay: Black Ombre + Bottom Fade -->
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-3xl bg-white/95 backdrop-blur-md p-10 rounded-[2rem] shadow-2xl border-l-[12px] border-yellow-400">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="<?php echo site_url('/locations'); ?>" class="bg-yellow-400 hover:bg-yellow-500 text-slate-900 font-bold py-4 px-10 rounded-2xl shadow-lg transition flex items-center justify-center gap-2 transform hover:-translate-y-1 text-center">Find Your Center <i data-lucide="chevron-right" class="w-5 h-5"></i></a>
                <a href="<?php echo site_url('/about'); ?>" class="bg-white text-slate-700 border-2 border-slate-200 hover:border-cyan-400 hover:text-cyan-600 font-bold py-4 px-10 rounded-2xl transition flex items-center justify-center text-center">Our Legacy</a>
            </div>
        </div>
    </div>
</header>
...
<section class="py-20 bg-slate-50 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid md:grid-cols-3 gap-6 lg:gap-10">
            <!-- Memphis -->
            <a href="<?php echo site_url('/memphis'); ?>" class="group relative rounded-[2.5rem] overflow-hidden h-96 shadow-lg cursor-pointer transform hover:-translate-y-2 transition duration-300">
            ...
            <!-- Atlanta -->
            <a href="<?php echo site_url('/locations'); ?>" class="group relative rounded-[2.5rem] overflow-hidden h-96 md:h-[28rem] md:-mt-8 shadow-2xl border-4 border-white cursor-pointer transform hover:-translate-y-2 transition duration-300">
            ...
            <!-- Doral -->
            <a href="<?php echo site_url('/doral'); ?>" class="group relative rounded-[2.5rem] overflow-hidden h-96 shadow-lg cursor-pointer transform hover:-translate-y-2 transition duration-300">
...
<!-- KIDAZZLE DIFFERENCE -->
<section class="pt-12 pb-24 bg-white border-t border-slate-100">
    <div class="container mx-auto px-4">
        <h2 class="text-4xl font-extrabold text-center text-slate-900 mb-16">The KIDazzle Difference</h2>
        <div class="grid md:grid-cols-4 gap-8">
            <a href="<?php echo site_url('/about'); ?>#meals" class="p-8 rounded-[2rem] border-2 border-orange-100 hover:border-orange-400 transition bg-white shadow-sm hover:shadow-xl text-center group block">
            ...
            <a href="<?php echo site_url('/about'); ?>#staff" class="p-8 rounded-[2rem] border-2 border-red-100 hover:border-red-400 transition bg-white shadow-sm hover:shadow-xl text-center group block">
            ...
            <a href="<?php echo site_url('/curriculum'); ?>" class="p-8 rounded-[2rem] border-2 border-cyan-100 hover:border-cyan-400 transition bg-white shadow-sm hover:shadow-xl text-center group block">
            ...
            <a href="<?php echo site_url('/about'); ?>#safety" class="p-8 rounded-[2rem] border-2 border-green-100 hover:border-green-400 transition bg-white shadow-sm hover:shadow-xl text-center group block">
...
<section class="pt-12 pb-24 bg-slate-50">
    ...
    <div class="max-w-6xl mx-auto px-6 bg-ombre-purple rounded-[3rem] p-12 text-center text-white shadow-2xl relative overflow-hidden">
        <div class="relative z-10">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="<?php echo site_url('/locations'); ?>" class="bg-white text-purple-700 px-8 py-3 rounded-xl font-bold hover:bg-purple-50 transition shadow-lg">View Locations</a>
            </div>
        </div>
    </div>
</section>
