            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (cards.length > 0) {
                    cards.forEach(card => {
                        ...
                        // We go up two parent nodes to catch the entire structural element
...
<div id="questionnaire-section" class="bg-slate-50 rounded-[2rem] p-6 md:p-10 border border-slate-200/60 my-10 shadow-sm">
    ...
    <div style="width: 100%; height: 800px; background: white; border-radius: 1rem; border: 1px solid #eae0d5; padding: 4px;" class="shadow-inner">
        <iframe src="https://api.leadconnectorhq.com/widget/form/61vvFgA8lleQiuqZKM4c" style="width:100%;height:100%;border:none;border-radius:12px" id="inline-61vvFgA8lleQiuqZKM4c" data-layout="{\'id\':\'INLINE\'}" data-trigger-type="alwaysShow" data-trigger-value="" data-activation-type="alwaysActivated" data-activation-value="" data-deactivation-type="neverDeactivate" data-deactivation-value="" data-form-name="Form 210" data-height="755" data-layout-iframe-id="inline-61vvFgA8lleQiuqZKM4c" data-form-id="61vvFgA8lleQiuqZKM4c" title="Form 210"></iframe>
