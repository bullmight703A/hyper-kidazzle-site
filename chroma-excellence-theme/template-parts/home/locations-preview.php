                        ...
                        <?php if (!empty($group['locations'])): ?>
                            <ul class="space-y-4">
                                <?php foreach ($group['locations'] as $location):
                                    ...
                                    <li class="pb-2">
                                        <div
                                            class="flex items-start justify-between gap-3 p-3 rounded-xl border border-chroma-blue/10 <?php echo esc_attr($hover_border . ' ' . $hover_bg); ?> transition">
                                            <div>
                                                <a href="<?php echo esc_url($url); ?>"
                                                    class="text-lg font-semibold text-brand-ink hover:text-chroma-blue transition-colors">
                                                    <?php echo esc_html($location['title']); ?>
                                                </a>
                                                <?php if ($city && $state): ?>
                                                    <div class="text-chroma-blue font-semibold">
