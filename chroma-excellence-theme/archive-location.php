...
if (!function_exists('chroma_get_region_color_from_term')) {
		...
		<div class="flex gap-2 justify-start lg:justify-end flex-wrap flex-grow items-center">
			...
			<?php foreach ($all_regions as $region):
				...
				<button onclick="filterLocations('<?php echo esc_attr($region->slug); ?>')"
					data-region="<?php echo esc_attr($region->slug); ?>" data-color-bg="<?php echo esc_attr($btn_bg); ?>"
					data-color-text="white"
			...
			<div class="w-full lg:w-1/2 relative z-10">
				<div
					...
					<div class="relative z-10 flex flex-wrap justify-center gap-4 p-6">
						...
						<div class="bg-chroma-green w-4 h-4 rounded-full animate-bounce" style="animation-delay: 0.4s;">
						</div>
						<div class="bg-chroma-blue w-4 h-4 rounded-full animate-bounce" style="animation-delay: 0.1s;">
						</div>
						<div class="bg-chroma-red w-4 h-4 rounded-full animate-bounce" style="animation-delay: 0.3s;">
						</div>
						<div class="bg-chroma-green w-4 h-4 rounded-full animate-bounce" style="animation-delay: 0.5s;">
						</div>
					</div>
