...
function chroma_program_details_meta_box_render( $post ) {
	...
	<div class="chroma-program-field">
		...
		<input type="text" id="program_icon" name="program_icon" value="<?php echo esc_attr( get_post_meta( $post->ID, 'program_icon', true ) ); ?>" placeholder="e.g., 👶, 🚀, 🎨, ✏️, 🎓, 🚌" style="width: 100px; text-align: center; font-size: 24px;" />
		<small><?php _e( 'Emoji or icon shown on home page program tiles (copy/paste emoji here)', 'chroma-excellence' ); ?></small>
	</div>
